...
module.exports.sendMailWithGmail = async (data)=>{
    ...
    let transporter = nodemailer.createTransport({
        ...
        auth:{
            ...
            refreshToken: process.env.REFRESH_TOKES,
                        ...
                        <td class="wrapper">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td> 
                                  <div class="image_div" > 
                                     <img class="image_peeppips" src="https://i.ibb.co/zZKxKvj/logo-1.png" /> 
                                  </div>
                                   <h5> ${data.text}</h5>
                                   <p>Name: ${data.name}</p>    
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="content-block powered-by">
                            Powered by <a href="https://1stSteps.com/">1stSteps.com</a>.
                          </td>
                        </tr>
                      </table>
                    </div>
    ...
    // console.log('info.messageId',nodemailer.getTestMessageUrl("info",info));
