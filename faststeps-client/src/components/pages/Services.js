...
import { useGetConsultationContentQuery, useGetFinancialContentQuery, useGetFoodContentQuery, useGetHomeContentQuery, useGetOfficeContentQuery } from '../../features/auth/authApi'
            ...
            <Container className='d-grid-c'> 
             ...
             <Container className='pt-5 pb-5 d-grid item-center'> 
                <div className='row w-80'>
                         ...
                         {languesState=== "arb"?  "عزز مشروعك الطهوي من خلال :" :"Enhance your culinary venture through:"}
                           </p>
                    ...
                    <div className='col-sm-12 col-md-4 col-lg-4 mt-2 mb-2'>
                        <button className='modal-package' onClick={e=> setValueOpenP(true)} >
                              <div className=''>
                                ...
                                <h6 className='mt-2'>{languesState=== "arb"?  "مكتب خاص":"Private Office"} </h6>
                              </div>
                        </button>
