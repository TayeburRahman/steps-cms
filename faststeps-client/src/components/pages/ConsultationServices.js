...
function ConsultationServices() {
    ...
    useEffect(() => {
        !consul_content && setLoader(true)
        consul_content && setLoader(false)
    }, [consul_content])
                            ...
                            <div className="row background-craping pt-5">
                                <div className='col-sm-12 col-md-7 col-lg-7 d-grid-c items-center mt-5 mb-5' >
                                    <div className="p-3 text-left from-join padding-sm-about jr-w5 text-home-html jr-p-n">
                                        ...
                                        <div className='mt-5' id={`${languesState === "arb" && "text-right"}`} > <Link className='more-link text-sm-button' to="/contact">
                                            {languesState === "arb" ? "ضاعف إمكانيات عملك الآن" : "  Maximize Your Business Impact Now"}   </Link></div>
                        ...
                        <div className='background-home'>
                            <Container className='pt-5 pb-5 d-grid item-center'>
                                <div className='row w-80'>
                                    ...
                                    <p className='text-left text-white pb-2' id={`${languesState === "arb"&& "text-right"}`}>
                                        {languesState === "arb" ? "نساعدك على مواجهة تحديات العمل من خلال" : "Approach business challenges with:"}
                                    </p>
                            ...
                            <div className='row content-center'>
                                <button className='modal-package w-custom-button ' onClick={e => setValueOpenE(true)}>
                                    <div className=''>
                                        ...
                                        <h6 className='mt-2'>  {languesState === "arb" ? "استكشف باقات الخدمات الاستشارية" : "Explore Our Advisory Packages"}</h6>
                                    </div>
                                </button>
