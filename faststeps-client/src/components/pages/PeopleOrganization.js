...
function PeopleOrganization() {
    ...
    const r3Content = people_content?.r3Content;
    ...
    return (
        <div>
            ...
            <div className='text-center text-black-html mx-w7 mt-3 mb-2 pt-5'
               ...
               <Link to="/contact" className='services-button-cu mb-5' > {languesState=== "arb"?"عزز إمكانات فريقك الآن":"Amplify Your Team's Potential Now"}</Link>
             </Container>
             <div className='background-home'>
             <Container className='pt-5 pb-5 d-grid item-center'> 
                         <div className='row w-70'>
                         <p className='text-left text-white pb-4'>Experience the premium touch of 1st Steps with:</p>
                         {
                ...
                <div className='row content-center'> 
                        <button className='modal-package w-custom-button ' onClick={e=> setValueOpenV(true)}>
                              <div className=''>
                                ...
                                <h6 className='mt-2'>{languesState=== "arb"?"اطّلع على باقات بناء الفريق لدينا":"View Our Team-Building Packages"}</h6>
                              </div>
                        </button>
