...
function Footer() {
    return (
        <div className='footer pt-5'>
          ...
          <div className='row'>
                <div className='col-sm-12 col-md-3 col-lg-3 text-right position-cus mb-5'>
                ...
                <div className='col-sm-5 col-md-2 col-lg-2 d-grid'>
                ...
                <h6 className='footer-link-text pb-4'> </h6>
                    ...
                    <div className='footer-link d-flex-ac'> <img src={whatsapp} className='me-1'/> 2413 Imam Saud Bin Abduaziz <br/>Mohamed Rd 7997 AL Muraslat Dist <br/> 12463 Riyadh, KSA</div>  
                </div> 
