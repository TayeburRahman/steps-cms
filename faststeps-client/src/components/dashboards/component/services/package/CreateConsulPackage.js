...
export default function CreateConsulPackage({ openPackage, setOpenPackage }) {

    const [valueEng, setValueEng] = useState('');
    const [valueArb, setValueArb] = useState('');

    const [packages, setPackage] = useState("explore_consul")
                    ...
                    <Box sx={style}>
                        ...
                        <div className='mt-3 mb-2'>
                            ...
                            <select id="package" name="package" onClick={e => (handleOnSelectLen(e.target.value))}>
                                <option value="explore_consul" >Explore Our Advisory Packages</option>
