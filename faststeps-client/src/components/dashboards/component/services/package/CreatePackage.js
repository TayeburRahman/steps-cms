...
export default function CreatePackage({ openPackage, setOpenPackage }) {
                    ...
                    <Box sx={style}>
                        ...
                        <div className='mt-3 mb-2'>
                            ...
                            <select id="package" name="package" onClick={e => (handleOnSelectLen(e.target.value))}>
                                <option value="meeting_office" >Meeting room</option>
                                <option value="shared_office">Shared work spaces</option>
                                <option value="view12_office">Private office 12 with view</option>
                                <option value="noView12_office">Private office 12 no view</option>
                                <option value="view18_office">Private office 18 with view</option>
                            </select>
                        </div>
