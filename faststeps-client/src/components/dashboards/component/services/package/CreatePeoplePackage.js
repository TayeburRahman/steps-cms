...
export default function CreatePeoplePackage({ openPackage, setOpenPackage }) {
                    ...
                    <Box sx={style}>
                        ...
                        <div className='mt-3 mb-2'>
                            ...
                            <select id="package" name="package" onClick={e => (handleOnSelectLen(e.target.value))}>
                                <option value="human_people" >Human Resource Managment</option>
                                <option value="recruitment_people">Recruitment service</option> 
                            </select>
                        </div>
